...
public class HierarchyPart {
	...
	private CellLabelProvider labelProvider = new CellLabelProvider() {
		...
		public Image getImage(Object element) {
			...
			case Module.KIND_SC_OBJECT          : return IMAGE_SC_OBJECT;
			case Module.KIND_SC_MODULE          : return IMAGE_SC_MODULE;
			case Module.KIND_SC_SIGNAL          : return IMAGE_SC_SIGNAL;
			case Module.KIND_SC_PORT            : return IMAGE_SC_PORT;
			case Module.KIND_SC_EXPORT          : return IMAGE_SC_EXPORT;
			case Module.KIND_SC_OUT             : return IMAGE_SC_OUT;
			case Module.KIND_SC_IN              : return IMAGE_SC_IN;
			case Module.KIND_SC_METHOD_PROCESS  : return IMAGE_SC_METHOD_PROCESS;
			case Module.KIND_SC_THREAD_PROCESS  : return IMAGE_SC_THREAD_PROCESS;
			case Module.KIND_VCML_IN_PORT       : return IMAGE_VCL_IN_PORT;
			case Module.KIND_VCML_OUT_PORT      : return IMAGE_VCL_OUT_PORT;
			case Module.KIND_VCML_MASTER_SOCKET : return IMAGE_VCL_MASTER_SOCKET;
			case Module.KIND_VCML_SLAVE_SOCKET  : return IMAGE_VCL_SLAVE_SOCKET;
			case Module.KIND_VCML_COMPONENT     : return IMAGE_VCML_COMPONENT;
			case Module.KIND_VCML_PROCESSOR     : return IMAGE_VCL_PROCESSOR;
			case Module.KIND_VCML_BUS           : return IMAGE_VCL_BUS;
			case Module.KIND_VCML_ROM           : return IMAGE_VCL_ROM;
			case Module.KIND_VCML_RAM           : return IMAGE_VCL_RAM;
			case Module.KIND_VCML_XBAR          : return IMAGE_VCL_XBAR;
			case Module.KIND_VCML_PERIPHERAL    : return IMAGE_VCL_PERIPHERAL;
			case Module.KIND_VCML_UART          : return IMAGE_VCL_UART;
			case Module.KIND_VCML_ETHERNET      : return IMAGE_VCL_ETHERNET;
			default:
